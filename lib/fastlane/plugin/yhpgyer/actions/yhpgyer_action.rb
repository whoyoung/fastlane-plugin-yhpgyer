...
require_relative '../helper/yhpgyer_helper'

module Fastlane
  module Actions
    class YhpgyerAction < Action
      def self.run(params)
      ...
      def self.return_value
        ...
        "qr code download url of ipa file"
      end
      ...
      def self.checkPublishStatus(client, api_host, api_key, buildKey)=begin  =end
